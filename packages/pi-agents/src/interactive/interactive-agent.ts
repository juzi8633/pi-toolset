...
import type { AgentConfig, AgentScope, Runtime } from '../config/agents.ts';
...
} from '../runtime/pi-rpc/pi-rpc-transport.ts';
import type { RunCoordinator } from '../run/run-coordinator.ts';
import { agentFingerprint } from '../run/run-coordinator.ts';
...
export interface InteractiveRegistryOptions {
  ...
  grokAcpTransportFactory?: (
    options: import('../runtime/grok-acp/grok-acp-interactive-transport.ts').GrokAcpInteractiveTransportOptions
...
export function createInteractiveAgentRegistry(options: InteractiveRegistryOptions) {
  ...
  async function createGrokAcpTransport(
    factoryOpts: import('../runtime/grok-acp/grok-acp-interactive-transport.ts').GrokAcpInteractiveTransportOptions
  ): Promise<InteractiveAgentTransport> {
