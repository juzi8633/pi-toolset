...
| 3 | Phase 8 Slice B (lock wait) | **Deferred** | [10-post-program-tx-lock-effect-wait.md](./10-post-program-tx-lock-effect-wait.md) — start only after this exit is accepted |
