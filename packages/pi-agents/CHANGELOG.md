...
* **pi-agents:** optimize implement-plan prompt for GPT-5.6 ([d3f287b](https://github.com/balaenis/pi-toolset/commit/d3f287b7c09d6e3140a82d9c5d1087dbc782ce40))
* **pi-agents:** simplify implement step and remove output format requirement ([6eb6996](https://github.com/balaenis/pi-toolset/commit/6eb6996d1a2a61d1040a517ecbb36feaca3c38c1))

## [0.4.4](https://github.com/balaenis/pi-toolset/compare/pi-agents-v0.4.3...pi-agents-v0.4.4) (2026-08-08)


### Bug Fixes

* **pi-agents:** drop review loop from implement prompt ([a6d9b8c](https://github.com/balaenis/pi-toolset/commit/a6d9b8c657a9197233f5df8156f01c67611b7dbc))

## [0.4.3](https://github.com/balaenis/pi-toolset/compare/pi-agents-v0.4.2...pi-agents-v0.4.3) (2026-08-08)


### Bug Fixes

* **pi-agents:** restore completion check failure handling ([b6e87e3](https://github.com/balaenis/pi-toolset/commit/b6e87e3c8c00b96e32da6ff2f6e8d0a014da4454))

## [0.4.2](https://github.com/balaenis/pi-toolset/compare/pi-agents-v0.4.1...pi-agents-v0.4.2) (2026-08-07)


### Bug Fixes

* **pi-agents:** drop Start Here from explore completion check ([3257f91](https://github.com/balaenis/pi-toolset/commit/3257f913a5e7b8053f1ac12fb25ee0db74254dff))

## [0.4.1](https://github.com/balaenis/pi-toolset/compare/pi-agents-v0.4.0...pi-agents-v0.4.1) (2026-08-07)


### Bug Fixes

* **pi-agents:** include skills directory in published files ([e65a32a](https://github.com/balaenis/pi-toolset/commit/e65a32a6b9d96c0301c0b638de120f84c2b51d86))
...
* **pi-agents:** support Pi 0.84 message_update wire shape ([65a6e0f](https://github.com/balaenis/pi-toolset/commit/65a6e0f2cb07fe563a6d95e7942156eba852be9a))
...
* **pi-agents:** resolve correct git root for linked worktrees on resume ([f19a107](https://github.com/balaenis/pi-toolset/commit/f19a107b1184fd4ed07544ff6362f766f27d71c2))
